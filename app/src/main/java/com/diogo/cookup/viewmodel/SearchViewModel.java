...
public class SearchViewModel extends ViewModel {
    ...
    public void fetchSuggestions(String query) {repository.fetchSearchResults(query, searchResult, errorMessage);}
    public void searchRecipes(String query) {repository.fetchSearchResults(query, searchResult, errorMessage);}
}
